...
if(isset($_REQUEST['isDelete'])){
    ...
    if($patient->delete($id)){
        echo("<script>location.href = '".BASE_URL."patient/list.php';</script>");
    }else{
                        ...
                        },
                        {
                            ...
                            render: (data, cell, row) => {
                                ...
                                return `<div class="flex items-center">
                                            <a href="<?=BASE_URL?>patient/edit.php?id=${data}&isEdit=true" class="ltr:mr-2 rtl:ml-2" x-tooltip="Edit">
                                            ...
                                            <a href="<?=BASE_URL?>patient/list.php?isDelete=true&id=${data}" x-tooltip="Delete">
