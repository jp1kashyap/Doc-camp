<div class="mb-8">
<h5>Q5e) During the past month, how often have you had trouble sleeping because you <br/>cough or snore loudly?</h5>
    <input type="hidden" name="question" value="5-e"/>
    <input type="hidden" name="score" value="<?=isset($oldAnswer['score'])?$oldAnswer['score']:"1"?>"/>
    <select id="q-9" name="answer" class="form-input" onchange="getScore(this)">
