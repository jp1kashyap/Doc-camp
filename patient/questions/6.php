<div class="mb-8">
<h5>Q5b) During the past month, how often have you had trouble sleeping because you <br/>wake up in the middle of the night or early morning?</h5>
    <input type="hidden" name="question" value="5-b"/>
    <input type="hidden" name="score" value="<?=isset($oldAnswer['score'])?$oldAnswer['score']:"1"?>"/>
    <select id="q-6" name="answer" class="form-input" onchange="getScore(this)">
