        ...
        Alpine.data("exportTable", () => ({
            ...
            init() {
                this.datatable = new simpleDatatables.DataTable('#myTable', {
                    data: {
                        headings: ['ID','Name','CODE','Reprting','Manager','State','Region','Action'],
                        ...
                        },
                        {
                            ...
                            render: (data, cell, row) => {
                                ...
                                return `<div class="flex items-center">
                                            <a href="<?=BASE_URL?>mr/edit.php?id=${data}&isEdit=true" class="ltr:mr-2 rtl:ml-2" x-tooltip="Edit">
                                            ...
                                            <a href="<?=BASE_URL?>mr/list.php?isDelete=true&id=${data}" x-tooltip="Delete">
