        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            <div class="flex justify-between items-center px-4 py-3">
                <a href="/" class="main-logo flex items-center shrink-0">
                    <img class="w-8 ml-[5px] flex-none" src="<?=BASE_URL?>assets/images/logo.svg" alt="image" />
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0" x-data="{ activeDropdown: null }">
                ...
                <li class="nav-item">
                    <ul>
                        <li class="nav-item">
                            <a href="<?=BASE_URL?>camp/add.php" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Add Camp</span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?=BASE_URL?>camp/list.php" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Camps List</span>
                                </div>
                            </a>
                        </li>
                </li>
