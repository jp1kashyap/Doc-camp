        ...
        Alpine.data("exportTable", () => ({
            ...
            init() {
                this.datatable = new simpleDatatables.DataTable('#myTable', {
                    data: {
                        headings: ['ID','Hospital','Location','Doctor Name','Doctor Code','Speciality','Date','Action'],
                        ...
                        },
                        {
                            ...
                            render: (data, cell, row) => {
                                ...
                                return `<div class="flex items-center">
                                            <a href="<?=BASE_URL?>camp/edit.php?id=${data}&isEdit=true" class="ltr:mr-2 rtl:ml-2" x-tooltip="Edit">
                                            ...
                                            <a href="<?=BASE_URL?>camp/list.php?isDelete=true&id=${data}" x-tooltip="Delete">
